const cli = require("../../build-wasm/bin/cli/cli.js")
...
exports.vote = function (tree_depth, voter_index, public_keys,
    ...
    cli._vote(tree_depth, voter_index, public_keys_super_buffer,
